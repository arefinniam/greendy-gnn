...
Usage from the repository root:
    python3 code/gen_figures.py [--data data/paper_data.json] [--out_dir figures]
"""
...
import numpy as np
os.environ.setdefault("MPLCONFIGDIR", os.path.join(tempfile.gettempdir(), "greendygnn-mpl"))
import matplotlib
matplotlib.use("Agg")
